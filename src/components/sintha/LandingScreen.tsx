  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <div className="mt-auto py-6 px-4 text-center border-t bg-white">
        ...
        {/* Powered by SINTHA AI — brief credit on the landing page */}
        <p className="text-[11px] text-gray-400 mb-3 max-w-md mx-auto leading-relaxed">
          Powered by <span className="font-medium text-purple-500">SINTHA AI</span> — smart provider search, price estimation, profile optimization &amp; 24/7 chat support.
        </p>
